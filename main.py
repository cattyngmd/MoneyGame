	...
	if slozhost == 1:
		while 1:
			try:
				...
				print("| 1. Пойти в магаз\n| 2. Пойти на работа\n| 3. Пойти на сон\n| 4. Выйти в окно\n| 5. Пойти в аптека\n| 6. Открыть портал в мир заработка (6666$)")
			...
			if select == 1:
				if bal > 0:
					os.system('cls' if os.name == 'nt' else 'clear')
					randHunger = random.randint(2, 4)
					randWeak = random.randint(2, 4)
					trata = random.randint(0, 200)
					randLLIaHc = random.randint(1,35)
					smert(randLLIaHc)
				...
				randIIpu6blLb = random.randint(150, 777)
				randHunger = random.randint(2, 3)
				randWeak = random.randint(3, 5)
				...
				os.system('cls' if os.name == 'nt' else 'clear')
				print(Fore.RED + "| Вы точно хотите выйти в окно?")
				print("| Да ---------------------- Нет")
				confirmation = input(Style.RESET_ALL + "| > ")
				if confirmation == "Да":
					print(Fore.GREEN + "GET STICK BUGGED LOL")
					time.sleep(5)
					exit()
				...
				randWeak = random.randint(2, 3)
				trata = random.randint(40, 200)
	...
	if slozhost == 3:
		while 1:
			try:
				...
				print("| Ваша статистика:\n| " + Fore.RED + str(health) + " Здоровья " + Fore.WHITE + "| " + Fore.GREEN + str(hunger) +" Сытости " + Fore.WHITE + "| " + Fore.CYAN + str(weak) + " Усталости " + Fore.WHITE + "| Баланс " + str(bal) + "$" + "\n| ---------------------------")
				print("| Выбери один из вариантов: ")
				print("| 1. Пойти в магаз\n| 2. Пойти на работа\n| 3. Пойти на сон\n| 4. Выйти в окно\n| 5. Пойти в аптека\n| 6. Открыть портал в мир заработка (8888$)")
			...
			if select == 1:
				if bal > 0:
					os.system('cls' if os.name == 'nt' else 'clear')
					randHunger = random.randint(2, 9)
					randWeak = random.randint(2, 5)
					trata = random.randint(0, 350)
					randLLIaHc = random.randint(1,17)
					smert(randLLIaHc)
				...
				os.system('cls' if os.name == 'nt' else 'clear')
				randtime = random.randint(6, 15)
				randIIpu6blLb = random.randint(50, 435)
				randHunger = random.randint(2, 4)
				randWeak = random.randint(4, 6)
				randHealth = random.randint(2, 4)
				...
				randHealth = random.randint(2, 8)
				randWeak = random.randint(2, 5)
				trata = random.randint(100, 350)
